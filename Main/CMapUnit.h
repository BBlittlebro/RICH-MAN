...
public:
    ...
    void SetFine(const int fine) { fine_ = fine; }         //設定罰金
    ...
    virtual void SetFineList(const int num[], const int n) {}
...
public:
    ...
    virtual void SetFineList(const int num[], const int n);                  //設定罰金陣列
